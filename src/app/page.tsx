...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      particles.forEach((p) => {
        ...
        ctx.fillStyle = `rgba(238, 139, 17, ${p.alpha})`;
        ctx.fill();
      });
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < 90) {
            ...
            ctx.strokeStyle = `rgba(238, 139, 17, ${0.06 * (1 - dist / 90)})`;
            ctx.lineWidth = 0.6;
            ctx.stroke();
          }
        }
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-[#f7f7f8] text-[#15161a]">
      
      {/* SuperAnnotate Exact Top Navigation */}
      <header className="sticky top-0 z-50 bg-[#f7f7f8]/90 backdrop-blur-md border-b border-black/5 h-[72px] flex items-center">
        <div className="max-w-[1320px] w-full mx-auto px-7 flex items-center justify-between">
          <a href="#" className="flex items-center gap-2.5">
            <img
              src="/superannotate_logo_gradient.svg"
              alt="SuperAnnotate"
          ...
          <div className="flex items-center gap-5">
            ...
            <button
              className="bg-[#15161a] text-white text-[14px] font-bold px-5 py-2.5 rounded-full hover:bg-black transition-transform transform hover:scale-105 cursor-pointer"
        ...
        <div className="max-w-[1320px] w-full mx-auto px-7 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
          ...
          <div className="lg:col-span-7 max-w-[680px]">
            <div className="flex items-center gap-2 mb-6">
              <span className="text-[#ee8b11] text-xs font-mono">★★★★★</span>
              <span className="text-[13.5px] font-extrabold text-[#15161a]">4.9</span>
              <span className="bg-[#ee8b11] text-white text-[10px] font-extrabold px-1.5 py-0.5 rounded">G2</span>
              <span className="text-[13px] text-gray-400 font-semibold">#1 AI Data Company</span>
            </div>

            <h1 className="font-display text-4xl md:text-6xl font-extrabold text-[#15161a] leading-[1.15] tracking-tight mb-6">
              <span className="bg-[#fcebd6] text-[#15161a] px-3 py-1 rounded-2xl border border-[#f7dec0]/30">Platform,</span>{" "}
              <span className="bg-[#fcebd6] text-[#15161a] px-3 py-1 rounded-2xl border border-[#f7dec0]/30">experts,</span> and{" "}
              <span className="bg-[#fcebd6] text-[#15161a] px-3 py-1 rounded-2xl border border-[#f7dec0]/30">workflows</span> to deliver the highest-quality AI data.
            </h1>

            <div className="pt-2">
              <button
                className="bg-[#15161a] text-white text-[14.5px] font-bold px-7 py-3.5 rounded-full shadow-lg hover:bg-black transition-all cursor-pointer"
          ...
          <div className="lg:col-span-5 relative h-[440px] hidden md:flex flex-col justify-center">
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none stroke-[#f7dec0]/40" strokeDasharray="3 3">
            ...
            {/* Pill 1 */}
            <div 
              className="absolute top-[10%] right-[18%] bg-white/95 border border-black/10 px-3.5 py-1.5 rounded-md shadow-sm flex items-center gap-2 text-[12.5px] font-semibold text-gray-800 cursor-pointer hover:border-[#ee8b11] transition-all"
              onClick={() => showToast("RL Environments selected")}
            >
              <span className="w-1.5 h-1.5 bg-[#ee8b11] rounded-sm"></span> RL Environments
            </div>

            {/* Pill 2 */}
            <div 
              className="absolute top-[26%] right-[5%] bg-white/95 border border-black/10 px-3.5 py-1.5 rounded-md shadow-sm flex items-center gap-2 text-[12.5px] font-semibold text-gray-800 cursor-pointer hover:border-[#ee8b11] transition-all"
              onClick={() => showToast("Multimodal Labeling selected")}
            >
              <span className="w-1.5 h-1.5 bg-[#ee8b11] rounded-sm"></span> Multimodal Labeling
            </div>

            {/* Pill 3 */}
            <div 
              className="absolute top-[44%] right-[28%] bg-white/95 border border-black/10 px-3.5 py-1.5 rounded-md shadow-sm flex items-center gap-2 text-[12.5px] font-semibold text-gray-800 cursor-pointer hover:border-[#ee8b11] transition-all"
              onClick={() => showToast("RLHF & SFT selected")}
            >
              <span className="w-1.5 h-1.5 bg-[#ee8b11] rounded-sm"></span> RLHF &amp; SFT
            </div>

            {/* Pill 4 */}
            <div 
              className="absolute top-[60%] right-[3%] bg-white/95 border border-black/10 px-3.5 py-1.5 rounded-md shadow-sm flex items-center gap-2 text-[12.5px] font-semibold text-gray-800 cursor-pointer hover:border-[#ee8b11] transition-all"
              onClick={() => showToast("Agent Trajectories selected")}
            >
              <span className="w-1.5 h-1.5 bg-[#ee8b11] rounded-sm"></span> Agent Trajectories
            </div>

            {/* Pill 5 */}
            <div 
              className="absolute top-[75%] right-[22%] bg-white/95 border border-black/10 px-3.5 py-1.5 rounded-md shadow-sm flex items-center gap-2 text-[12.5px] font-semibold text-gray-800 cursor-pointer hover:border-[#ee8b11] transition-all"
              onClick={() => showToast("Evaluation selected")}
            >
              <span className="w-1.5 h-1.5 bg-[#ee8b11] rounded-sm"></span> Evaluation
            </div>

            {/* Pill 6 */}
            <div 
              className="absolute top-[88%] right-[12%] bg-white/95 border border-black/10 px-3.5 py-1.5 rounded-md shadow-sm flex items-center gap-2 text-[12.5px] font-semibold text-gray-800 cursor-pointer hover:border-[#ee8b11] transition-all"
              onClick={() => showToast("Off-the-shelf Datasets selected")}
            >
              <span className="w-1.5 h-1.5 bg-[#ee8b11] rounded-sm"></span> Off-the-shelf Datasets
            </div>
      ...
      <section className="py-24 bg-[#f7f7f8]" id="infra">
        <div className="max-w-[1320px] w-full mx-auto px-7">
          <div className="text-xs font-extrabold text-[#ee8b11] tracking-widest uppercase mb-3">• INFRASTRUCTURE</div>
          <h2 className="font-display text-4xl font-extrabold text-[#15161a] leading-tight tracking-tight mb-4 max-w-3xl">
            ...
            {["cv", "rlhf", "agents", "eval", "datasets"].map((tabKey) => (
              <button
                ...
                className={`py-3.5 px-5 font-bold text-sm whitespace-nowrap cursor-pointer border-b-2 -mb-[2px] transition-all ${
                  activeTab === tabKey ? "border-[#ee8b11] text-black" : "border-transparent text-gray-500 hover:text-black"
                }`}
                onClick={() => {
                  setActiveTab(tabKey);
          ...
          <div className="bg-[#15161a] rounded-2xl p-6 text-white shadow-2xl border border-white/10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              
              <div className="lg:col-span-3 bg-[#2e3038] rounded-xl p-4 flex flex-col gap-2 border border-white/5">
                ...
                {["bbox", "polygon", "sam", "keypoint", "cuboid"].map((t) => (
                  <button
                    ...
                    className={`p-3 rounded-lg text-xs font-semibold flex items-center gap-2.5 cursor-pointer border transition-all ${
                      activeTool === t ? "bg-[#ee8b11] border-[#ee8b11] text-white" : "border-white/10 text-white hover:bg-white/5"
                    }`}
                    onClick={() => {
                      setActiveTool(t);
              ...
              <div className="lg:col-span-6 bg-black rounded-xl min-h-[420px] relative overflow-hidden flex items-center justify-center border border-white/10">
                ...
                />
                <div className="absolute top-[22%] left-[30%] w-[42%] h-[48%] border-2 border-[#ee8b11] bg-[#ee8b11]/15 rounded">
                  <span className="absolute -top-6 -left-0.5 bg-[#ee8b11] text-white text-[11px] font-mono font-bold px-2 py-0.5 rounded shadow">
                    Autonomous_Vehicle (98.4%)
                  </span>
                </div>
              </div>

              <div className="lg:col-span-3 bg-[#2e3038] rounded-xl p-5 border border-white/5 flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="text-xs font-mono font-bold text-[#2c5dc4]">Autonomous_Vehicle</div>
                    </div>
                    <div>
                      <div className="text-[11px] text-gray-400 mb-0.5">Model Assistance</div>
                      <div className="text-xs font-mono font-bold text-[#2c5dc4]">Segment Anything (SAM)</div>
                    </div>
                    <div>
                      <div className="text-[11px] text-gray-400 mb-0.5">Confidence Score</div>
                      <div className="text-xs font-mono font-bold text-[#2c5dc4]">0.9842</div>
                    </div>
                  </div>
                </div>

                <button
                  className="w-full mt-6 bg-[#3b3e49] hover:bg-black border border-white/20 text-white font-bold py-2.5 rounded-lg text-xs cursor-pointer transition-all"
      ...
      <section className="py-24 bg-[#f7f7f8]" id="experts">
        <div className="max-w-[1320px] w-full mx-auto px-7">
          
          <h2 className="font-display text-4xl md:text-5xl font-extrabold text-[#15161a] tracking-tight mb-3">
            Not just tooling
          </h2>
          ...
          <div className="bg-white border border-black/10 rounded-2xl p-8 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
            ...
            <div className="lg:col-span-5 bg-[#f7f7f8] rounded-xl p-8 flex items-center justify-center relative min-h-[360px] border border-black/5">
              <svg className="absolute inset-0 w-full h-full pointer-events-none stroke-[#f7dec0]/50" strokeDasharray="3 3">
              ...
              <div className="relative w-full h-full min-h-[300px] flex items-center justify-center">
                {/* Center Node */}
                <div className="w-4 h-4 rounded-full bg-[#ee8b11] shadow-md z-10"></div>
            ...
            <div className="lg:col-span-7 flex flex-col justify-center space-y-6">
              ...
              <div>
                <h3 className="font-display text-2xl font-extrabold text-[#15161a] mb-2">Expert humans, in the loop</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 rounded-xl border border-gray-100 hover:border-gray-300 transition-all flex gap-4 items-start">
                  <div className="w-9 h-9 rounded-lg bg-[#fcebd6] text-[#ee8b11] flex items-center justify-center font-bold text-sm shrink-0">
                    <i className="fa-solid fa-user-doctor"></i>
                  </div>
                  <div>
                    <h4 className="text-base font-bold text-[#15161a]">Expert Services</h4>
                ...
                <div className="p-4 rounded-xl border border-gray-100 hover:border-gray-300 transition-all flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-[#15161a]">AI-Assisted Annotation</h4>
                ...
                <div className="p-4 rounded-xl border border-gray-100 hover:border-gray-300 transition-all flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-[#15161a]">Off-the-shelf Datasets</h4>
                ...
                <div className="p-4 rounded-xl border border-gray-100 hover:border-gray-300 transition-all flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-[#15161a]">Data Collection</h4>
          ...
          <div className="mb-8">
            <h3 className="font-display text-2xl font-extrabold text-[#15161a] mb-2">Every vendor, one secure system</h3>
            <p className="text-sm text-gray-500 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white border border-black/10 rounded-xl p-6 shadow-sm flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg bg-[#fcebd6] text-[#ee8b11] flex items-center justify-center text-base shrink-0">
                  <i className="fa-solid fa-[#shield-halved]"></i>
                </div>
                <div>
                  <h4 className="text-base font-bold text-[#15161a] mb-1">SOC 2 Type II &amp; HIPAA Compliant</h4>
              ...
              <div className="bg-white border border-black/10 rounded-xl p-6 shadow-sm flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-base font-bold text-[#15161a] mb-1">Zero Data Retention Option</h4>
      ...
      <footer className="bg-[#15161a] text-gray-400 py-16 text-xs border-t border-white/10" id="legal">
        <div className="max-w-[1320px] w-full mx-auto px-7">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
            
            <div className="md:col-span-2">
              <div className="flex items-center gap-2.5 mb-3">
                <img src="/superannotate_logo_gradient.svg" alt="SuperAnnotate" className="h-6 w-auto object-contain brightness-0 invert" />
              </div>
              ...
              <div className="bg-[#2e3038] border border-white/10 p-4 rounded-lg">
                <div className="text-xs font-bold text-white mb-1">SuperAnnotate AI, Inc.</div>
                <div className="text-[11px] text-gray-500 mt-1">SOC 2 Type II &amp; HIPAA compliant infrastructure</div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 list-none">
                ...
                <li><a href="#" className="hover:text-white" onClick={() => showToast("SDK: pip install superannotate")}>Python SDK</a></li>
          ...
          <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <div>&copy; 2026 SuperAnnotate AI, Inc. All Rights Reserved.</div>
      ...
      {/* Toast Bar */}
      {toastMsg && (
        <div className="fixed bottom-6 right-6 bg-[#15161a] text-white border border-[#ee8b11] px-5 py-3 rounded-lg font-bold text-xs shadow-2xl z-50">
          <i className="fa-solid fa-circle-check text-[#ee8b11] mr-2"></i> {toastMsg}
        </div>
      )}
